...
export default function ArtistDetail() {
  ...
  const prevArtist = artistIndex > 0 ? ARTISTS[artistIndex - 1] : ARTISTS[ARTISTS.length - 1];
  const nextArtist = artistIndex < ARTISTS.length - 1 ? ARTISTS[artistIndex + 1] : ARTISTS[0];
  ...
  if (!artist) {
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center flex-col gap-6">
        ...
        <Link href="/artists">
          <span className="px-6 py-3 bg-primary text-black font-bold rounded-lg cursor-pointer">Voltar para artistas</span>
        </Link>
      </div>
    );
  }
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            ...
            <div className="flex flex-col md:flex-row gap-10 lg:gap-16 items-center md:items-end">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                >
                  <a href="#" className="px-6 py-3 bg-primary text-primary-foreground font-bold rounded-lg hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(255,75,216,0.4)] hover:shadow-[0_0_25px_rgba(255,75,216,0.6)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-24">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed whitespace-pre-line font-medium">
                    {artist.bio}
                  </p>
                </motion.div>
